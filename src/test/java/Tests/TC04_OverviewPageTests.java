...
public class TC04_OverviewPageTests {
    ...
    public void CheckOutStepOne() throws FileNotFoundException {
        ...
        LogsUtils.info("ZipCode used in this test case is " + zipcode);


        Assert.assertTrue(Util.VerifyRedirectToPage(getDriver(), "https://www.saucedemo.com/checkout-step-two.html"));
    }
